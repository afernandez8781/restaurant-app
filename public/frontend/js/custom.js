...
(function($) {
    "use strict";
		...
		$('.switcher').click(function(){
			...
			jQuery('#changeable-colors').attr('href', '/frontend/css/colors/' + title + '.css');				
			return false;
		});	
		
		jQuery(".orange-bg").on('click',function(){
			jQuery(".logo-header img").attr("src", "frontend/images/logo.png");
			jQuery(".footer-logo .text-center img").attr("src", "frontend/images/logo.png");
			return false;
		});

		jQuery(".strong-blue-bg").on('click',function(){
			jQuery(".logo-header img").attr("src", "frontend/images/logo2.png");
			jQuery(".footer-logo .text-center img").attr("src", "frontend/images/logo2.png");
			return false;
		});

		jQuery(".moderate-green-bg").on('click',function(){
			jQuery(".logo-header img").attr("src", "frontend/images/logo3.png");
			jQuery(".footer-logo .text-center img").attr("src", "frontend/images/logo3.png");
			return false;
		});

		jQuery(".vivid-yellow-bg").on('click',function(){
			jQuery(".logo-header img").attr("src", "frontend/images/logo4.png");
			jQuery(".footer-logo .text-center img").attr("src", "frontend/images/logo4.png");
			return false;
		});
