...
<head>
    ...
    <!-- color -->
    <link id="changeable-colors" rel="stylesheet" href="{{asset('frontend/css/colors/orange.css')}}" />
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    <div class="wow fadeIn" data-wow-duration="1s" data-wow-delay="0.1s">
                        <div class="about-images">
                            <img class="about-main" src="{{asset('frontend/images/about-main.jpg')}}" alt="About Main Image">
                            <img class="about-inset" src="{{asset('frontend/images/about-inset.jpg')}}" alt="About Inset Image">
                        </div>
                    </div>
                </div>
                <!-- end col -->
                    ...
                    <div class="special-box">
                        <div id="owl-demo">
                            <div class="item item-type-zoom">
                                ...
                                <div class="item-img">
                                    <img src="{{asset('frontend/images/special-menu-1.jpg')}}" alt="sp-menu">
                                </div>
                            </div>
                            <div class="item item-type-zoom">
                                <a href="#" class="item-hover">
                                ...
                                <div class="item-img">
                                    <img src="{{asset('frontend/images/special-menu-2.jpg')}}" alt="sp-menu">
                                </div>
                            </div>
                            <div class="item item-type-zoom">
                                <a href="#" class="item-hover">
                                ...
                                <div class="item-img">
                                    <img src="{{asset('frontend/images/special-menu-3.jpg')}}" alt="sp-menu">
                                </div>
                            </div>
                            <div class="item item-type-zoom">
                                <a href="#" class="item-hover">
                    ...
                    <div class="tab-menu">
                        ...
                        <div class="slider slider-single">
                            <div>
                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 ">
                                    <div class="offer-item">
                                        <img src="{{asset('frontend/images/menu-item-thumbnail-01.jpg')}}" alt="" class="img-responsive">
                                        <div>
                                            <h3>GARLIC BREAD</h3>
                                            <p>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 ">
                                    <div class="offer-item">
                                        <img src="{{asset('frontend/images/menu-item-thumbnail-02.jpg')}}" alt="" class="img-responsive">
                                        <div>
                                            <h3>MIXED SALAD</h3>
                                            <p>
                                                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc mollis eleifend dapibus.
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 ">
                                    <div class="offer-item">
                                        <img src="{{asset('frontend/images/menu-item-thumbnail-03.jpg')}}" alt="" class="img-responsive">
                                        <div>
                            ...
                            <div>
                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 ">
                                    <div class="offer-item">
                                        <img src="{{asset('frontend/images/menu-item-thumbnail-04.jpg')}}" alt="" class="img-responsive">
                                        <div>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 ">
                                    <div class="offer-item">
                                        <img src="{{asset('frontend/images/menu-item-thumbnail-05.jpg')}}" alt="" class="img-responsive">
                                        <div>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 ">
                                    <div class="offer-item">
                                        <img src="{{asset('frontend/images/menu-item-thumbnail-06.jpg')}}" alt="" class="img-responsive">
                                        <div>
                            ...
                            <div>
                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 ">
                                    <div class="offer-item">
                                        <img src="{{asset('frontend/images/menu-item-thumbnail-07.jpg')}}" alt="" class="img-responsive">
                                        <div>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 ">
                                    <div class="offer-item">
                                        <img src="{{asset('frontend/images/menu-item-thumbnail-08.jpg')}}" alt="" class="img-responsive">
                                        <div>
                                            <h3>CHICKEN TIKKA MASALA</h3>
                                            <p>
                                                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc mollis eleifend dapibus.
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 ">
                                    <div class="offer-item">
                                        <img src="{{asset('frontend/images/menu-item-thumbnail-09.jpg')}}" alt="" class="img-responsive">
                                        <div>
                                            <h3>CHICKEN TIKKA MASALA</h3>
                                            <p>
                                                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc mollis eleifend dapibus.
                            ...
                            <div>
                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 ">
                                    <div class="offer-item">
                                        <img src="{{asset('frontend/images/menu-item-thumbnail-10.jpg')}}" alt="" class="img-responsive">
                                        <div>
                                            <h3>MEAT FEAST PIZZA</h3>
                                            <p>
                                                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc mollis eleifend dapibus.
                    ...
                    <div class="team-box">
                        ...
                        <div class="row">
                            <div class="col-md-4 col-sm-6">
                                <div class="sf-team">
                                    <div class="thumb">
                                        <a href="#"><img src="{{asset('frontend/images/staff-01.jpg')}}" alt=""></a>
                                    </div>
                                    <div class="text-col">
                                        <h3>John Doggett</h3>
                            ...
                            <div class="col-md-4 col-sm-6">
                                <div class="sf-team">
                                    <div class="thumb">
                                        <a href="#"><img src="{{asset('frontend/images/staff-02.jpg')}}" alt=""></a>
                                    </div>
                                    <div class="text-col">
                            ...
                            <div class="col-md-4 col-sm-6">
                                <div class="sf-team">
                                    <div class="thumb">
                                        <a href="#"><img src="{{asset('frontend/images/staff-03.jpg')}}" alt=""></a>
                                    </div>
                                    <div class="text-col">
                                        <h3>Monica Reyes</h3>
                                        <p>Nullam quis ante. Etiam sit amet orci eget eros faucibus tincidunt. Duis leo. Sed fringilla mauris sit amet nibh. Donec sodales sagittis magna. Aenean commodo ligula.</p>
                        ...
                        <div class="col-md-8 col-sm-12 co-xs-12 gal-item">
                            <div class="box">
                                <a href="#" data-toggle="modal" data-target="#1">
                                    <img src="{{asset('frontend/images/gallery_01.jpg')}}" alt="" />
                                </a>
                        ...
                        <div class="col-md-4 col-sm-6 co-xs-12 gal-item">
                            <div class="box">
                                <a href="#" data-toggle="modal" data-target="#2">
                                    <img src="{{asset('frontend/images/gallery_02.jpg')}}" alt="" />
                                </a>
                        ...
                        <div class="col-md-4 col-sm-6 co-xs-12 gal-item">
                            <div class="box">
                                <a href="#" data-toggle="modal" data-target="#3">
                                    <img src="{{asset('frontend/images/gallery_03.jpg')}}" alt="" />
                                </a>
                        ...
                        <div class="col-md-4 col-sm-6 co-xs-12 gal-item">
                            <div class="box">
                                <a href="#" data-toggle="modal" data-target="#4">
                                    <img src="{{asset('frontend/images/gallery_04.jpg')}}" alt="" />
                                </a>
                        ...
                        <div class="col-md-4 col-sm-6 co-xs-12 gal-item">
                            <div class="box">
                                <a href="#" data-toggle="modal" data-target="#5">
                                    <img src="{{asset('frontend/images/gallery_05.jpg')}}" alt="" />
                                </a>
                        ...
                        <div class="col-md-4 col-sm-6 co-xs-12 gal-item">
                            <div class="box">
                                <a href="#" data-toggle="modal" data-target="#9">
                                    <img src="{{asset('frontend/images/gallery_06.jpg')}}" alt="" />
                                </a>
                        ...
                        <div class="col-md-8 col-sm-12 co-xs-12 gal-item">
                            <div class="box">
                                <a href="#" data-toggle="modal" data-target="#10">
                                    <img src="{{asset('frontend/images/gallery_07.jpg')}}" alt="" />
                                </a>
                        ...
                        <div class="col-md-4 col-sm-6 co-xs-12 gal-item">
                            <div class="box">
                                <a href="#" data-toggle="modal" data-target="#11">
                                    <img src="{{asset('frontend/images/gallery_08.jpg')}}" alt="" />
                                </a>
                        ...
                        <div class="col-md-4 col-sm-6 co-xs-12 gal-item">
                            <div class="box">
                                <a href="#" data-toggle="modal" data-target="#12">
                                    <img src="{{asset('frontend/images/gallery_09.jpg')}}" alt="" />
                                </a>
                        ...
                        <div class="col-md-4 col-sm-6 co-xs-12 gal-item">
                            <div class="box">
                                <a href="#" data-toggle="modal" data-target="#13">
                                    <img src="{{asset('frontend/images/gallery_10.jpg')}}" alt="" />
                                </a>
